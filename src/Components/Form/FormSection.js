        ...
        <div style={{ fontFamily: 'Open Sans' }} >
            ...
            >
              ...
              <Form.Item required>
                ...
                <Input defaultValue="centimeter(cm)" style={{ width: '30%' }} disabled />
              </Form.Item>
              <Form.Item required>
              ...
              <Form.Item required>
                ...
                <Input defaultValue="kilograms (Kg)" style={{ width: '30%' }} disabled />
              </Form.Item>
              <Form.Item required>
                <div style={{ color: "#EFF3F8", fontSize: 16}}>Temperature</div>
                <Input placeholder="98.6" style={{ width: '70%' }}  />
                <Input defaultValue="farenheit" style={{ width: '30%' }} disabled />
              </Form.Item>
              <Form.Item required>
              ...
              <Form.Item>
                <Button style={{ backgroundColor: '#0ED470', color:'#11151B', width: '100%', fontWeight: 600, fontSize: 14 }} >GENERATE REPORT</Button>
              </Form.Item>
            </Form>
        </div>
    )
